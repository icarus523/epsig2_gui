...
class epsig2_gui(threading.Thread):
    ...
    def GetSeedText(self):
        ...
        logging.info("Seed Modifed to: " + self.seed.seed)
    ...
    def startEpsig2GUI(self, filepath): 
        ...
        if cachedhit:
            ...
            outputstr = "%-50s\t%-s\t" % (epsig2.format_output(self, str(localhash), self.gui_getOptions()), 
    ...
    def updateGUI_epsig(self, hash_result): 
        ...
        str_output = epsig2.format_output(self, hash_result, self.gui_getOptions())
