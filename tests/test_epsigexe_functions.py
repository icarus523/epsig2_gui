...
class test_epsigexe_functions(epsig2GUI_TestClient):   

    # 'bnkfiles/5D81F_W4QLQ05M.BNK'
    # utilising epsig.exe
    ...
    # 'G:/OLGR-TECHSERV/BINIMAGE/KONAMI/1645GDXX_393_004.BNK'
    # utilising epsig.exe
    ...
    # 'bnkfiles/5D81F_W4QLQ05M.BNK'
    # Verify output format: 8 char spaces and lower case
    @unittest.skipIf(os.path.isfile(BNK_FILE_LOCAL) == False, "file not found")
    ...
    # 'bnkfiles/5D81F_W4QLQ05M_3.BNK' # two file suffixes
    # using epsig.exe 
    ...
    # W4QLQ05M.sigs SHA1 # two file suffixes 
    # bad filename
    @unittest.skipIf(os.path.isfile(BNK_FILE_LOCAL) == False, "file not found")
    ...
    # 'G:/OLGR-TECHSERV/BINIMAGE/Wymac/G0351_004_301103.BNK'
