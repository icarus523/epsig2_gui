...
class test_epsig2gui_manufacturers_BNK_test(epsig2GUI_TestClient):   
    ...
    def test_ARI_BNK_test(self): 
        ...
        epsigexe_output = epsig2_gui.epsigexe_start(self, ARI_BNK, self.seed)
