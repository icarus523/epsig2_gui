...
class test_Seed(epsig2GUI_TestClient): 
    ...
    def test_Seed_SHA1_truncation(self): 
        ...
        self.assertEqual('00000000000000000000000094C5809DEA787F15', my_seed.getSeed())
    ...
    def test_Seed_SHA256_appending(self): 
        ...
        self.assertEqual('94C5809DEA787F1584A5CA6CFDF4210A9E831018000000000000000000000000', my_seed.getSeed())
    ...
    def test_Seed_SHA256_no_truncation(self): 
        ...
        self.assertEqual('00000000000000000000000094C5809DEA787F1584A5CA6CFDF4210A9E831018', my_seed.getSeed())
